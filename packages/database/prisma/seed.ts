...
async function main() {
  ...
  const contests = await prisma.contest.createMany({
    data: [
      {
        name: 'LeetCode Weekly Contest 504',
        platform: Platform.LEETCODE,
        url: 'https://leetcode.com/contest/weekly-contest-504',
      ...
      {
        name: 'Codeforces Round 1110 (Div. 2)',
        platform: Platform.CODEFORCES,
        url: 'https://codeforces.com/contest/1110',
        externalId: '1110',
        difficulty: 'Div. 2',
      ...
      {
        name: 'CodeChef Starters 234',
        platform: Platform.CODECHEF,
        url: 'https://www.codechef.com/START234',
      ...
      {
        name: 'LeetCode Biweekly Contest 182',
        platform: Platform.LEETCODE,
        url: 'https://leetcode.com/contest/biweekly-contest-182',
